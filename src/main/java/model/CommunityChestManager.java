...
public class CommunityChestManager {
    private static final Card INCOME_TAX_REFUND = new ReceiveCard("Income Tax Refund\nCollect $20", 20);
    private static final Card GIC_ISSUES_DIVIDENDS = new ReceiveCard("GIC issues dividends\nCollect $100", 100);
    private static final Card ADVANCE_TO_GO = new AdvanceToGoCard("Advance to GO\n(Collect $200)");
    private static final Card INHERITANCE = new ReceiveCard("You inherit $100", 100);
    private static final Card DOCTOR_FEE = new PayBankCard("Doctor's fee\nPay $50", 50);
    private static final Card GRAND_OPERA_OPENING = new CollectFromPlayersCard("Grand Opera Opening\nCollect $50 from every player\nFor opening night seats", 50);
    private static final Card LIFE_INSURANCE = new ReceiveCard("Life insurance matures\nCollect $100", 100);
    private static final Card PAY_HOSPITAL = new PayBankCard("Pay hospital $100", 100);
    private static final Card GO_TO_JAIL = new GoToJailCard("Go to jail\nGo Directly to jail\nDo no pass GO\nDo not collect $200");
    private static final Card BANK_ERROR = new ReceiveCard("Bank error in your favour\nCollect $200", 200);
    private static final Card STREET_REPAIRS = new PayPerHouseCard("You are assessed for street repairs\n$40 per house\n$115 per hotel", 40, 115);
    ...
    private static final Card SECOND_PRIZE = new ReceiveCard("You have won second prize in a lucky draw\nCollect 10", 10);
    private static final Card SCHOOL_FEES = new PayBankCard("Pay school fees of $150", 150);
    private static final Card SALE_STOCK = new ReceiveCard("From sale fo stock you get $45", 45);
    private static final Card SERVICES = new ReceiveCard("Receive for services $250", 250);
